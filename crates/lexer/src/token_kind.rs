...
mod tests {
    ...
    fn check_stream(input: &str, tokens: Vec<TokenKind>) {
    ...
    #[test]
    fn integer() {
        check("123", TokenKind::Integer);
        check("1", TokenKind::Integer);
    }

    #[test]
    fn hex() {
        check("0xabc123", TokenKind::Hex);
        check("0xDEADBEEF", TokenKind::Hex);
    }

    #[test]
    fn octal() {
        check("0o01234567", TokenKind::Octal);
    }

    #[test]
    fn binary() {
        check("0b10010010", TokenKind::Binary);
    }

    #[test]
    fn floats() {
        check("123.123", TokenKind::Float);
        check("123.", TokenKind::Float);
        check(".123", TokenKind::Float);
    }

    #[test]
    fn expontentials() {
        check("e3123", TokenKind::Exponential);
        check("E233", TokenKind::Exponential);
        check("f433", TokenKind::Exponential);
        check("F3", TokenKind::Exponential);
    }
    ...
    fn compond_exponentials() {
        check_stream(
            "123.123e123",
            vec![TokenKind::Float, TokenKind::Exponential],
        );
        check_stream(".123e123", vec![TokenKind::Float, TokenKind::Exponential]);
        check_stream("123e123", vec![TokenKind::Integer, TokenKind::Exponential]);
        check_stream(
            "123.123e123",
            vec![TokenKind::Float, TokenKind::Exponential],
        );
        check_stream(".123f123", vec![TokenKind::Float, TokenKind::Exponential]);
        check_stream("123f123", vec![TokenKind::Integer, TokenKind::Exponential]);
    }
}
